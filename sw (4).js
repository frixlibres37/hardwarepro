// HardwarePro Service Worker v8 — NUCLEAR UPDATE
...
async function handleStatic(req) {
  try {
    ...
    return caches.match(req).then(c => c || caches.match(INDEX_URL));
  }
}
